...
- [ProductBundleCartsRestApi ^1.6.0](https://github.com/spryker/product-bundle-carts-rest-api) (Legacy Glue)
...
- [ProductBundlesRestApi ^1.4.0](https://github.com/spryker/product-bundles-rest-api) (Legacy Glue)
